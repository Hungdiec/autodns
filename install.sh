...
read -p "Enter server IP or hostname for CNAME record: " SERVER_IP_OR_HOSTNAME
...
SERVER_IP_OR_HOSTNAME = "${SERVER_IP_OR_HOSTNAME}"
EOF
...
[Unit]
Description=Update NPM Proxy Hosts and Cloudflare DNS Records
